(function () {
    ...
    datasets: [
      {
        ...
        fillColor: "rgba(122, 112, 186, 0.4)",
        strokeColor: MofiAdminConfig.primary,
        highlightFill: "rgba(122, 112, 186, 0.6)",
        highlightStroke: MofiAdminConfig.primary,
        data: [35, 59, 80, 81, 56, 55, 40],
      },
      {
        label: "My Second dataset",
        fillColor: "rgba(72, 163, 215, 0.4)",
        strokeColor: MofiAdminConfig.secondary,
        highlightFill: "rgba(72, 163, 215, 0.6)",
        highlightStroke: MofiAdminConfig.secondary,
  ...
  var polarData = [
    {
      ...
      highlight: MofiAdminConfig.primary,
      label: "Yellow",
    },
    {
      value: 50,
    ...
    },
    {
      ...
      highlight: MofiAdminConfig.secondary,
      label: "Dark Grey",
    },
  ];
  var polarOptions = {
  ...
  var lineGraphData = {
    ...
    datasets: [
      {
        label: "My First dataset",
        fillColor: "rgba(122, 112, 186, 0.3)",
        strokeColor: MofiAdminConfig.primary,
        pointColor: MofiAdminConfig.primary,
      ...
      {
        label: "My Second dataset",
        fillColor: "rgba(72, 163, 215, 0.3)",
        strokeColor: MofiAdminConfig.secondary,
        pointColor: MofiAdminConfig.secondary,
        pointStrokeColor: "#fff",
        pointHighlightFill: "#000",
        pointHighlightStroke: MofiAdminConfig.secondary,
        data: [28, 48, 40, 19, 86, 27, 90],
      },
    ],
  };
    ...
    datasets: [
      {
        ...
        strokeColor: MofiAdminConfig.primary,
        pointColor: MofiAdminConfig.primary,
        pointStrokeColor: MofiAdminConfig.primary,
        pointHighlightFill: MofiAdminConfig.primary,
        pointHighlightStroke: "rgba(122, 112, 186, 0.4)",
        data: [12, 3, 5, 18, 7],
      },
    ],
  };
  ...
  var myLineChart = {
    ...
    datasets: [
      ...
      {
        fillColor: "rgba(72, 163, 215, 0.2)",
        strokeColor: MofiAdminConfig.secondary,
        pointColor: MofiAdminConfig.secondary,
        data: [20, 40, 10, 20, 40, 30, 40, 10, 20],
      },
      {
        fillColor: "rgba(122, 112, 186, 0.2)",
        strokeColor: MofiAdminConfig.primary,
        pointColor: MofiAdminConfig.primary,
