(function ($) {
      ...
      xaxis: [
        {
          ...
          label: {
            ...
            style: {
              color: "#fff",
              background: MofiAdminConfig.primary,
            },
            text: "Anno Test",
          },
        },
  ...
  var optionsCircle = {
    ...
    colors: [MofiAdminConfig.secondary, MofiAdminConfig.primary, "#51bb25"],
    responsive: [
      {
        breakpoint: 767,
        options: {
  ...
  var optionsProgress1 = {
    ...
    plotOptions: {
      bar: {
        ...
        barHeight: "15%",
        colors: {
          backgroundBarColors: [MofiAdminConfig.primary],
  ...
  var optionsProgress2 = {
    ...
    plotOptions: {
      bar: {
        ...
        barHeight: "15%",
        colors: {
          backgroundBarColors: [MofiAdminConfig.secondary],
          backgroundBarOpacity: 0.2,
    ...
    fill: {
      ...
      gradient: {
        inverseColors: false,
        gradientToColors: [MofiAdminConfig.secondary],
      },
    },
    responsive: [
      {
