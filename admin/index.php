                ...
                <div class="card profile-greeting p-0">
                    <div class="card-body">
                        <div class="img-overlay">
                            ...
                            <p>Welcome to the Mofi family! We are delighted that you have visited our dashboard.</p><a
                                class="btn" href="index.html">Go Premium</a>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="d-flex align-items-center gap-3">
                                <div class="location-menu dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="userdropdown"><a
                                            ...
                                            href="#">Geo-Menu</a><a class="dropdown-item" href="#">Place Picker</a>
                                    </div>
                                </div>
                                <div class="dropdown icon-dropdown">
                                ...
                                <tbody>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0"><img
                                                        src="../assets/images/dashboard/project/1.png" alt="">
                                                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0"><img
                                                        src="../assets/images/dashboard/project/2.png" alt="">
                                                </div>
                                                <div class="flex-grow-1 ms-2"><a href="product-page.html">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0"><img
                                                        src="../assets/images/dashboard/project/3.png" alt="">
                                                </div>
                                                <div class="flex-grow-1 ms-2"><a href="product-page.html">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0"><img
                                                        src="../assets/images/dashboard/project/4.png" alt="">
                                                </div>
                                                <div class="flex-grow-1 ms-2"><a href="product-page.html">
                        ...
                        <ul class="notification-box">
                            <li class="d-flex">
                                <div class="flex-shrink-0 bg-light-primary"><img
                                        src="../assets/images/dashboard/icon/wallet.png" alt="Wallet"></div>
                            ...
                            <li class="d-flex">
                                <div class="flex-shrink-0 bg-light-info"><img
                                        src="../assets/images/dashboard/icon/shield-dne.png" alt="Shield-dne"></div>
                                <div class="flex-grow-1"> <a href="private-chat.html">
                            ...
                            <li class="d-flex">
                                <div class="flex-shrink-0 bg-light-warning"> <img
                                        src="../assets/images/dashboard/icon/graph.png" alt="Graph"></div>
                                <div class="flex-grow-1"> <a href="private-chat.html">
                            ...
                            <li class="d-flex">
                                <div class="flex-shrink-0 bg-light-tertiary"><img
                                        src="../assets/images/dashboard/icon/ticket-star.png" alt="Ticket-star"></div>
                                <div class="flex-grow-1"> <a href="private-chat.html">
                                        <h5>Recently Paid</h5>
                                    </a>
                            ...
                            <div class="col-5">
                                <ul class="appointments-user">
                                    <li class="d-flex align-items-center">
                                        <div class="flex-shrink-0"><img src="../assets/images/dashboard/user/05.png"
                                                alt=""></div>
                                        <div class="flex-grow-1"><a href="private-chat.html">
                                                <h5>John Elliot</h5>
                                            </a>
                                    ...
                                    <li class="d-flex align-items-center">
                                        <div class="flex-shrink-0"><img src="../assets/images/dashboard/user/06.png"
                                                alt=""></div>
                                        <div class="flex-grow-1"><a href="private-chat.html">
                                                <h5>Ashley Hart</h5>
                                            </a>
                                    ...
                                    <li class="d-flex align-items-center">
                                        <div class="flex-shrink-0"><img src="../assets/images/dashboard/user/07.png"
                                                alt=""></div>
                                        <div class="flex-grow-1"><a href="private-chat.html">
                                                <h5>Anna lverson</h5>
                                            </a>
                                    ...
                                    <li class="d-flex align-items-center">
                                        <div class="flex-shrink-0"><img src="../assets/images/dashboard/user/08.png"
                                                alt=""></div>
                                        <div class="flex-grow-1"><a href="private-chat.html">
                                                <h5>Dana Lemon</h5>
                                            </a>
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0"><img
                                                        src="../assets/images/dashboard/user/01.jpg" alt=""></div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0"><img
                                                        src="../assets/images/dashboard/user/02.jpg" alt=""></div>
                                                <div class="flex-grow-1"><a href="product.html">
                                                        <h5>Ashley Hart</h5>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0"><img
                                                        src="../assets/images/dashboard/user/03.jpg" alt=""></div>
                                                <div class="flex-grow-1"><a href="product.html">
                                                        <h5>Anna lverson </h5>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0"><img
                                                        src="../assets/images/dashboard/user/04.jpg" alt=""></div>
                                                <div class="flex-grow-1"><a href="product.html">
                                                        <h5>Ron Dayley</h5>
                ...
                <div class="card">
                    ...
                    <div class="card-body sale-statistic">
                        <div class="row">
                            ...
                            <div class="col-3 statistic-icon">
                                <div class="light-card balance-card widget-hover">
                                    <div class="icon-box"><img src="../assets/images/dashboard/icon/profit.png" alt="">
                                    </div>
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0"><img
                                                        src="../assets/images/dashboard/product/1.png" alt="">
                                                </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0"><img
                                                        src="../assets/images/dashboard/product/2.png" alt="">
                                                </div>
                                                <div class="flex-grow-1"><a href="list-products.html">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0"><img
                                                        src="../assets/images/dashboard/product/3.png" alt="">
                                                </div>
                                                <div class="flex-grow-1"><a href="list-products.html">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0"><img
                                                        src="../assets/images/dashboard/product/4.png" alt="">
                                                </div>
                                                <div class="flex-grow-1"><a href="list-products.html">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0"><img
                                                        src="../assets/images/dashboard/product/5.png" alt="">
                                                </div>
                                                <div class="flex-grow-1"><a href="list-products.html">
